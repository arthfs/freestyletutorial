...
export default function Glossary() {
  const ref: { [x: string]: string  }  = {'latw':'Lemmens around the world','hmatw':'homie mitch around the world',
    'laatw':'lemmens abbas around the world','htatw':"homie touzani around the world",'atw':'around the world','tatw':'touzani around the world','lmatw':'lemmens mitch around the world',
